...
from pseudos.serializers.projects import ProjectSerializer
...
class ProjectView(ListAPIView):
    ...
    def get_queryset(self):
        ...
        return Projects.objects.filter(vertical_id=vertical_id).exclude(vertical_id=None)
...
class ProjectDetailView(APIView):
    ...
    def get(self, request, pk):
        queryset = Projects.objects.filter(pk=pk).first()
    ...
    def put(self, request, pk):
        ...
        serializer = ProjectSerializer(queryset, data=request_data)
        if serializer.is_valid():
            serializer.save()
    ...
    def delete(self, request, pk):
        Projects.objects.filter(pk=pk).delete()
